...
select c.cus_gender, count(CUS_Gender) as Number_of_Customer
...
from orders o
inner join product_details p on o.PROD_ID=p.PRO_ID
inner join product pd on pd.PRO_ID=p.PRO_ID
where o.CUS_ID=2;
